...
public class ReviewController {
    ...
    public ReviewController(final ReviewRepository reviewRepository, final RestaurantRepository restaurantRepository){
    ...
    public Review submitReview(@RequestBody Review review) throws Exception {
            ...
            @RequestParam(name="min-score", required = false) Integer minScore)
    {
        ...
        if (minScore!= null && minScore > 0 && minScore <= 5){
            ...
            throw new ResponseStatusException(HttpStatus.NOT_ACCEPTABLE, "An invalid minimum score has been entered.");
        }
    }
